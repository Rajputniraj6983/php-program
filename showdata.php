...
<body>
    ...
    if(isset($_REQUEST['edit'])) {
        ...
        $_SESSION['carname'] = $_REQUEST['carname'];
    ...
    <div class="row mt-5">
        <div class="col-lg-10 mx-auto">
            <div class="card shadow-sm">
                <div class="card-body">
                    <h3 class="card-title text-center mb-4">Car List</h3>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <form method="post">
                                            ...
                                            <input type="hidden" name="carname" value="<?php echo $res['name']; ?>">
                                            <input type="hidden" name="model" value="<?php echo $res['description']; ?>">
